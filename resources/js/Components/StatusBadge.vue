...
const severities = {
    ...
    info: ['filed', 'published', 'in_progress', 'instructed', 'reminder_sent', 'under_examination', 'normal', 'billable', 'issued', 'matched', 'publication', 'renewal_reminder', 'time', 'submitted'],
